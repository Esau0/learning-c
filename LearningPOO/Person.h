class Person {
    ...
    public:
        ...
        Person(string name);
        // destructor
        Person(string name, int age, string genre, string birthday);
...
Person::Person(string name, int age, string genre, string birthday) {
    // Defining variables throught constructor
    this->name = name;
    this->age = age;
    this->genre = genre;
    this->birthday = birthday;
    cout<< "pOO ahora el cumpleaños"<<endl;
    }
...
void Person::describePerson(){
    ...
    cout << "POO Describing genre: " << this->birthday<< endl;
}
